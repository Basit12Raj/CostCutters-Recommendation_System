...
const FlipkartTopDeals = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:3001/compare/produc'); // Updated URL to match your backend
  ...
  return (
    <div id='flipkart' className="bg-gray-100 p-6 relative">
      {/* Heading */}
      <h1 className="text-4xl text-center ml-8 text-[#303030] font-semibold mb-4 mt-20"><span className='text-red-700 font-bold'>Flipkart</span> Top Deals</h1>
      <p className='text-center ml-8 text-black text-lg mb-14'>Design, refined performance and windows 10 built in, it’s the smart choice for your business.</p>
